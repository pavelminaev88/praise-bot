/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 20b4b51c3f88c768c3ecee3f4ae013ee)
...
interface __BaseEnv_Env {
	...
	REPLY_WORKFLOW: Workflow<Parameters<import("./src/index").ReplyWorkflow['run']>[0]['payload']>;
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "MODEL" | "TRANSCRIBE_MODEL" | "MAX_VOICE_SECONDS" | "MEMORY_MESSAGES" | "MEMORY_TTL_HOURS" | "TELEGRAM_BOT_TOKEN" | "ANTHROPIC_API_KEY" | "OPENAI_API_KEY" | "TELEGRAM_API_BASE" | "ANTHROPIC_API_BASE" | "OPENAI_API_BASE" | "ADMIN_TELEGRAM_ID">> {}
}
